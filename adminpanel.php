<?php
    ...
    //echo '<pre>' . print_r($projects, 1) . '</pre>';
     ...
     // educatio
     $stmtLD = $pdo->prepare("SELECT * FROM education WHERE user_id = :zon_uid"); // prepare() - подготавливает запрос к выполнению
     $stmtLD->execute([':zon_uid' => $user_id]);// Подставляем реальные знчаение вместо параметров
     $education = $stmtLD->fetch(PDO::FETCH_ASSOC);// fetch() - достает одну строку из результата поиска
...
<body class="bg-light container">
    ...
    <div class="card p-3 mb-4">
        ...
        <a href="portfolio.php">Страница портфолио</a>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="adminpanel.php">
                ...
                <div class="row mb-4">
                    <!--Поле: учебное учреждение  -->
                    <div class="col-6">
                        <label for="ed" class="form-label">Название учебного учереждения</label>
                        <input type="text" class="form-control" id="ed" placeholder="Введите название учебного учереждения" name="get_ed">
                    </div>
                    <!--Поле: Профессия  -->
                    <div class="col-6">
                        <label for="spec_ed" class="form-label">Специализация</label>
                        <input type="text" class="form-control" id="spec_ed" placeholder="Введите название вашей специальности" name="get_spec_ed" value="<?php echo $education['spec_ed'] ?? ''; ?>">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <!--Поле: дата начала  -->
                    <div class="col-6">
                        <label for="start_eddate" class="form-label">дата начала</label>
                        <input type="text" class="form-control" id="start_eddate" placeholder="Введите дату" name="get_start_eddate" value="<?php echo $education['start_eddate'] ?? ''; ?>">
                        <div class="form-text">В формате: 12.09.2007</div>
                    </div>
                    <!--Поле: дата окончания  -->
                    <div class="col-6">
                        <label for="end_eddate" class="form-label">Дата окончания</label>
                        <input type="text" class="form-control" id="end_eddate" placeholder="Введите дату" name="get_end_eddate" value="<?php echo $education['end_eddate'] ?? ''; ?>">
                        <div class="form-text">В формате: 12.09.2007</div>
                    </div>
                </div>
                <button type="submit" name="save_portfolio" class="btn btn-warning">Сохранить данные</button>
