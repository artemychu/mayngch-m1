...
// едукация
$Edname     = $education['ed']         ?? 'образование не заполнено';
$eddate     = $education['start_eddate']     ?? 'дата не заполнена';
$endate     = $education['end_eddate']       ?? 'дата не заполнена';
$specialEd  = $education['spec_ed']          ?? 'квалификация не заполнена';
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="card">
                ...
                <?php if (empty($skills)): ?>
                      <p class="empty">Вы не заполнили образование!</p>
                <?php else: ?>
                        <?php foreach ($skills as $el): ?>
                                <div class="skill-item">
                                    <div class="skill-header">
